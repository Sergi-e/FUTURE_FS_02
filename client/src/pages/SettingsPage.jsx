    ...
    <Page>
      <div className="mx-auto max-w-lg">
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-white/55">
          Signed in as <span className="font-medium text-slate-800 dark:text-white/80">{user?.email}</span>
        </p>

        <section className="mt-8 rounded-2xl border border-slate-200/80 bg-white/60 p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <label className="block text-xs font-medium text-slate-600 dark:text-white/65">
              ...
              <input
                ...
                className="mt-1 w-full rounded-lg border border-slate-300/80 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none ring-2 ring-transparent transition focus:ring-brand-violet/50 dark:border-white/15 dark:bg-white/5 dark:text-white"
